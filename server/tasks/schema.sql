-- This schema is based on your provided schema.sql file.
-- It defines the structure of the SQLite database for each league.
...
CREATE TABLE IF NOT EXISTS daily_lineups_dump (
  ...
  b8 TEXT, b9 TEXT, b10 TEXT, i1 TEXT, i2 TEXT, i3 TEXT, i4 TEXT, i5 TEXT
);
...
CREATE TABLE IF NOT EXISTS rosters (
    ...
    p16 INTEGER, p17 INTEGER, p18 INTEGER, p19 INTEGER
);
